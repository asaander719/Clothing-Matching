...
def _get_UIs_for_J_(conf, dataset, model, train_ui_pairs):
    ...
    with open('./dataset/IQON3000/data/J_topk_UIs_dict.json', 'w') as json_file:
    ...
    with open('./dataset/IQON3000/data/j_topk_Us_Is_dict.json', 'w') as json_file:
...
def main():
    ...
    train_df.columns = [
        'user_idx', 'top_idx', 'pos_bottom_idx', 'neg_bottom_idx'
    ]
